      ...
      <html>
        ...
        <body>
          ...
          <p>
            ...
            property rights related to it, still belong to Vivek Kumar.
          </p>{" "}
          <p>
            Vivek Kumar is committed to ensuring that the app is as useful and
          ...
          <p>
            The DesiCharge app stores and processes personal data that you have
            ...
            mean that the DesiCharge app won’t work properly or at all.
          </p>{" "}
          <div>
            <p>
          ...
          <p>
            You should be aware that there are certain things that Vivek Kumar
            ...
            provider, but Vivek Kumar cannot take responsibility for the app not
          ...
          <p>
            Along the same lines, Vivek Kumar cannot always take responsibility
            ...
            it on to avail the Service, Vivek Kumar cannot accept
            responsibility.
          </p>{" "}
          <p>
            With respect to Vivek Kumar’s responsibility for your use of the
            ...
            so that we can make it available to you. Vivek Kumar accepts no
          ...
          <p>
            ...
            the updates if you want to keep using the app. Vivek Kumar does not
          ...
          <p>These terms and conditions are effective as of 2021-09-18</p>{" "}
          <p>
